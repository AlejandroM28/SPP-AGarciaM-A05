 ...
 */
public class SPPAGarciaMA05 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        int V1=solicitaEntero("Dame un número entero");
        double V2=solicitaDouble ("Dame un número decimal");
        String V3=solicitaString ("Dame una frase");
